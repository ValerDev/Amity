...
import truck from "../../assets/images/ForBusiness/image.png";
import s from "./ForBusinesses.module.scss";
import { Header } from "../../components/Header/Header";
import { businessData } from "../../data";
import { Footer } from "../Footer/Footer";

export const ForBusiness = () => {
  const { header, subTitle, description, sections, info } = businessData;
  return (
